...
#pragma mark - NativeTurboSqliteDatabase

template <typename P0, typename P1>
struct NativeTurboSqliteDatabase {
  P0 executeSql;
  P1 close;
  bool operator==(const NativeTurboSqliteDatabase &other) const {
    return executeSql == other.executeSql && close == other.close;
  }
};

template <typename T>
struct NativeTurboSqliteDatabaseBridging {
  static T types;
...
#pragma mark - NativeTurboSqliteSqlResult

template <typename P0, typename P1, typename P2>
struct NativeTurboSqliteSqlResult {
  P0 rows;
  P1 rowsAffected;
  P2 insertId;
  bool operator==(const NativeTurboSqliteSqlResult &other) const {
    return rows == other.rows && rowsAffected == other.rowsAffected && insertId == other.insertId;
  }
};

template <typename T>
struct NativeTurboSqliteSqlResultBridging {
  static T types;
